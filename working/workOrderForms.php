            ...
            <div class="spotlight">
  		    ...
  		    <!--<div class = "requiredFields">* From must be completely filled out</div>-->
                    ...
                    <form id = "community_form" method = "post" action = "">
                        ...
                        <fieldset>
                            <strong><legend>Customer Information</legend></strong>
                             &nbsp;&nbsp;&nbsp
                          
                            <p>Are you a Green River student or faculty member? &nbsp;&nbsp;
                                <input type = "radio" id = "student_faculty" name = "student_faculty" value="yes" <?php if (isset($_POST['student_faculty']) && $_POST['student_faculty']=='yes') {echo 'checked="checked"';}?> >Yes &nbsp;&nbsp;&nbsp 
                        ...
                        <fieldset>
                            <strong><legend>Computer Information</legend></strong>
                             &nbsp;&nbsp;&nbsp
                            <p>Is your computer language English?
                                <input type = "radio" name = "computer_language" id = "computer_language" value="yes" <?php if (isset($_POST['computer_language']) && $_POST['computer_language']=='yes') {echo 'checked="checked"';}?> >Yes &nbsp;&nbsp;&nbsp
                            ...
                            <p>
                                ...
                                <input type = "radio" name = "ccleaner" id = "ccleaner" value="yes" <?php if (isset($_POST['ccleaner']) && $_POST['ccleaner']=='yes') {echo 'checked="checked"';}?>>Yes  &nbsp;&nbsp;&nbsp
                        ...
                        <?php
                        echo '<fieldset>';
                        echo '<strong><legend>Types of Issues</legend></strong><br>';
